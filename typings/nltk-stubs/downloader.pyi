...
class Downloader:
    ...
    def collections(self): # -> dict_values:
        ...
    
    def incr_download(self, info_or_id, download_dir=..., force=...): # -> Generator[SelectDownloadDirMessage | Any | ErrorMessage | StartCollectionMessage | FinishCollectionMessage | StartPackageMessage | ProgressMessage | UpToDateMessage | FinishPackageMessage | StaleMessage | StartDownloadMessage | FinishDownloadMessage | StartUnzipMessage | FinishUnzipMessage, Any, None]:
        ...
